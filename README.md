...
> **Latest: v1.4.8** — Tray icon lifecycle hardened (no more silent disappearance), notify-icon always-show promotion, Emergency Stop / Settings / Restart Tray failsafes, multi-language auto-route (including Hebrew), plus prior clipboard lock immunity. Both Source ZIP and Portable EXE are **GitHub Artifact Attested**. See **[Releases](https://github.com/nickotmazgin/fluentvoice-pro/releases/latest)**.
