...
> **Latest: v1.4.13** — Settings footer: action buttons row + divider + status stacked left (no collision with Emergency Stop); one desktop FluentVoice icon; tray visibility hardened; multi-language auto-route (including Hebrew). Both Source ZIP and Portable EXE are **GitHub Artifact Attested**. See **[Releases](https://github.com/nickotmazgin/fluentvoice-pro/releases/latest)**.
