...
> **Latest: v1.4.4** — Packaging refresh: community/security docs in the source ZIP, contain-fit GitHub social preview, Actions/CodeQL hardening. App behavior same as **v1.4.3** (tray revive, hotkey, volume, auto-route, attested ZIP + portable EXE). See **[Releases](https://github.com/nickotmazgin/fluentvoice-pro/releases/latest)**.
