...
> **Latest: v1.4.14** — Factory reset in About (confirmed); speech modulation reset fully syncs defaults; Settings footer no longer crowds Emergency Stop; tray hardened; multi-language auto-route (including Hebrew). Both Source ZIP and Portable EXE are **GitHub Artifact Attested**. See **[Releases](https://github.com/nickotmazgin/fluentvoice-pro/releases/latest)**.
